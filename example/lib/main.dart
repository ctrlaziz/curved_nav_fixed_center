...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const CurvedNavDemo(),
      debugShowCheckedModeBanner: false,
    );
  }
}

/// Main demo showcasing the FixedCurvedNavigationBar widget
class CurvedNavDemo extends StatefulWidget {
  const CurvedNavDemo({super.key});
...
class _CurvedNavDemoState extends State<CurvedNavDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Curved Nav Fixed Center Demo'),
      ...
      bottomNavigationBar: FixedCurvedNavigationBar(
        ...
        style: FixedCurvedStyle(
          ...
          navigationBarHeight:
              90, // Background height (smaller to allow center button protrusion)
